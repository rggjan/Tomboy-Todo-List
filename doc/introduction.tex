...
\begin{objects}
	...
	\object{Task}{A task is an entry of a Task List. It may have a due date, a priority and can be marked as done. \index{Task}}
	\object{Task Note}{A Task is an entry of a Task List. It may have a due date and a priority \index{Task Note}}
