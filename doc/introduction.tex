...
\begin{reference_table}
  ...
  \reference{LGPL}{\index{LGPL} \url{http://www.gnu.org/licenses/lgpl.txt}}
  \reference{IEEE 830-1998}{\url{http://standards.ieee.org/reading/ieee/std/se/830-1998.pdf}}
  \reference{ICAL Specification}{\index{ICAL} \url{http://tools.ietf.org/html/rfc5545}}
\end{reference_table}
